pipeline {
    ...
    stages {
        ...
        stage('Dockerbuild'){
			steps{
					sh 'whoami'
					sh 'docker build -t http://ec2-54-151-159-79.ap-southeast-1.compute.amazonaws.com:8081/repository/simplejavamaven .'
        ...
        stage('Dockerpush') {
            steps{
                ...
                //withCredentials([aws(credentialsId: 'aws-cli-creds', region: 'ap-southeast-1')]) {
                    ...
                    sh 'docker push http://ec2-54-151-159-79.ap-southeast-1.compute.amazonaws.com:8081/repository/simplejavamaven:latest'
                //}
            }
        }
